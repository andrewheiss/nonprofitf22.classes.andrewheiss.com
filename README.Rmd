...
2. Open `nonprofitf22.Rproj` to open an [RStudio Project](https://r4ds.had.co.nz/workflow-projects.html).
...
```{r include=FALSE}
workflow <- targets::tar_mermaid(targets_only = TRUE, outdated = FALSE, 
