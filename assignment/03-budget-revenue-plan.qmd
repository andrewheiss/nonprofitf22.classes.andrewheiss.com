...
Discuss your concerns with each of the sources of revenue you're pursuing and explain how to mitigate those concerns (recall the content from [the class session on fundraising](/class/13-class.qmd): volatility, goal displacement, and process & structure effects).
