...
You will be working in a team throughout the semester, so make sure you coordiante with your teammates when sickness strikes. 
...
<small>GSU does not require this and I can't legally require this but I am allowed to urge it so here's me urging it:</small><br>Please get the COVID-19 vaccination ([sign up for one here!](https://covidinfo.gsu.edu/covid-19-resources/covid-19-vaccine/)). It is free. It saves lives. (I am fully vaccinated and boosted.)
...
<small>GSU also does not require this and I can't legally require this but, again, I'm allowed to urge it, so:</small><br>Following [CDC guidlines](https://www.cdc.gov/coronavirus/2019-ncov/vaccines/fully-vaccinated-guidance.html), **I strongly recommend/urge/encourage you to wear a mask in class** regardless of your vaccination status. I will place a box of disposable masks by the door if you would like one.
...
Because of the pandemic and [my family situation](#masks-and-vaccines), it is easiest to meet with me online via Webex for student hours. [Make an appointment with me here](https://calendly.com/andrewheiss/), and then use this link to talk to me during student hours: <https://gsumeetings.webex.com/meet/aheiss>. You can also find me through e-mail.
...
assignments <- tribble(
  ~Points,   ~Assignment,
  20 * 11.5, "Pre-class check-ins (20 × 11.5)",
  40,        "Why nonprofits?",
